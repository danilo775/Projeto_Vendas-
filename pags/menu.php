<?php 
	if(isset($_SESSION['conectado']) &&  $_SESSION['conectado'] != true || !isset($_SESSION['conectado']) )
	{
					...
					<ul class="navbar-nav w-100 align-items-center">
						...
						<li class="nav-item dropdown  me-2">
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
								<li><a class="dropdown-item" href="./relatorioVendas.php">Vendas Por Período</a></li>
								<li><a class="dropdown-item" href="">Total de Vendas</a></li>
								<li><a class="dropdown-item" href="./relatorioLucro.php">Margem de Lucro</a></li>
