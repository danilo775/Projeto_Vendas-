	...
	<div class="corpo">
		<div class="menu">
 		...
 		<div class="busca  mt-3">	 	
			<legend id="legenda"> <h1> Lista de Vendas por Clientes  </h1></legend>
		...
		<table class="table " id="tablePagamento">
			...
			<tr>
				...
				<td id="cor_valor"> <?php echo number_format($row['valor'], 2, ',', '.'); ?> </td>
				<td> <?php echo is_null($row['valor_pago']) ? '0,00 ' : number_format($row['valor_pago'], 2, ",", ".") ; ?> </td>
				
				<td> <?php echo number_format($row['saldo_devedor'], 2, ',', '.'); ?> </td>
