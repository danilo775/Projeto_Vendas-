		...
		<form action="../action/editaCliente.php" method="POST">
			...
			<div class="row ">
				...
				<div class="form-group col" >
					...
					<input type="text" name="celular"value="<?php echo $linha['celular']; ?> " id="celular" class="form-control" maxlength="11">
				</div>
			...
			<div class="row ">
				...
				<div class="form-group col">
					...
					<input type="text" name="cpf"value="<?php echo $linha['cpf']; ?> " id="cpf" class="form-control" maxlength="11">
				</div>
			</div>
